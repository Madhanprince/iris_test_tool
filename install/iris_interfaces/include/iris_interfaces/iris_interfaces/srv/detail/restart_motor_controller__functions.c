...
iris_interfaces__srv__RestartMotorController_Request__init(iris_interfaces__srv__RestartMotorController_Request * msg)
{
  ...
  // restart_reason
  if (!rosidl_runtime_c__String__init(&msg->restart_reason)) {
    iris_interfaces__srv__RestartMotorController_Request__fini(msg);
    return false;
  }
  return true;
}
...
iris_interfaces__srv__RestartMotorController_Request__fini(iris_interfaces__srv__RestartMotorController_Request * msg)
{
  ...
  // restart_reason
  rosidl_runtime_c__String__fini(&msg->restart_reason);
}
...
iris_interfaces__srv__RestartMotorController_Request__are_equal(const iris_interfaces__srv__RestartMotorController_Request * lhs, const iris_interfaces__srv__RestartMotorController_Request * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->restart_reason), &(rhs->restart_reason)))
  {
    return false;
  }
  return true;
  ...
  iris_interfaces__srv__RestartMotorController_Request * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->restart_reason), &(output->restart_reason)))
  {
    return false;
  }
  return true;
...
iris_interfaces__srv__RestartMotorController_Request__create()
{
  ...
  iris_interfaces__srv__RestartMotorController_Request * msg = (iris_interfaces__srv__RestartMotorController_Request *)allocator.allocate(sizeof(iris_interfaces__srv__RestartMotorController_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(iris_interfaces__srv__RestartMotorController_Request));
  bool success = iris_interfaces__srv__RestartMotorController_Request__init(msg);
  if (!success) {
...
iris_interfaces__srv__RestartMotorController_Request__Sequence__init(iris_interfaces__srv__RestartMotorController_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  iris_interfaces__srv__RestartMotorController_Request * data = NULL;

  if (size) {
    data = (iris_interfaces__srv__RestartMotorController_Request *)allocator.zero_allocate(size, sizeof(iris_interfaces__srv__RestartMotorController_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = iris_interfaces__srv__RestartMotorController_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        iris_interfaces__srv__RestartMotorController_Request__fini(&data[i - 1]);
      }
...
iris_interfaces__srv__RestartMotorController_Request__Sequence__fini(iris_interfaces__srv__RestartMotorController_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      iris_interfaces__srv__RestartMotorController_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  iris_interfaces__srv__RestartMotorController_Request__Sequence * array = (iris_interfaces__srv__RestartMotorController_Request__Sequence *)allocator.allocate(sizeof(iris_interfaces__srv__RestartMotorController_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = iris_interfaces__srv__RestartMotorController_Request__Sequence__init(array, size);
  if (!success) {
...
iris_interfaces__srv__RestartMotorController_Request__Sequence__destroy(iris_interfaces__srv__RestartMotorController_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    iris_interfaces__srv__RestartMotorController_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
iris_interfaces__srv__RestartMotorController_Request__Sequence__are_equal(const iris_interfaces__srv__RestartMotorController_Request__Sequence * lhs, const iris_interfaces__srv__RestartMotorController_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!iris_interfaces__srv__RestartMotorController_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  iris_interfaces__srv__RestartMotorController_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(iris_interfaces__srv__RestartMotorController_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    iris_interfaces__srv__RestartMotorController_Request * data =
      (iris_interfaces__srv__RestartMotorController_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!iris_interfaces__srv__RestartMotorController_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          iris_interfaces__srv__RestartMotorController_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!iris_interfaces__srv__RestartMotorController_Request__copy(
...
iris_interfaces__srv__RestartMotorController_Response__init(iris_interfaces__srv__RestartMotorController_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->result)) {
    iris_interfaces__srv__RestartMotorController_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  iris_interfaces__srv__RestartMotorController_Response * msg = (iris_interfaces__srv__RestartMotorController_Response *)allocator.allocate(sizeof(iris_interfaces__srv__RestartMotorController_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(iris_interfaces__srv__RestartMotorController_Response));
  bool success = iris_interfaces__srv__RestartMotorController_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
iris_interfaces__srv__RestartMotorController_Response__Sequence__init(iris_interfaces__srv__RestartMotorController_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  iris_interfaces__srv__RestartMotorController_Response * data = NULL;

  if (size) {
    data = (iris_interfaces__srv__RestartMotorController_Response *)allocator.zero_allocate(size, sizeof(iris_interfaces__srv__RestartMotorController_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = iris_interfaces__srv__RestartMotorController_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        iris_interfaces__srv__RestartMotorController_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
iris_interfaces__srv__RestartMotorController_Response__Sequence__fini(iris_interfaces__srv__RestartMotorController_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      iris_interfaces__srv__RestartMotorController_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  iris_interfaces__srv__RestartMotorController_Response__Sequence * array = (iris_interfaces__srv__RestartMotorController_Response__Sequence *)allocator.allocate(sizeof(iris_interfaces__srv__RestartMotorController_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = iris_interfaces__srv__RestartMotorController_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
iris_interfaces__srv__RestartMotorController_Response__Sequence__destroy(iris_interfaces__srv__RestartMotorController_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    iris_interfaces__srv__RestartMotorController_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
iris_interfaces__srv__RestartMotorController_Response__Sequence__are_equal(const iris_interfaces__srv__RestartMotorController_Response__Sequence * lhs, const iris_interfaces__srv__RestartMotorController_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!iris_interfaces__srv__RestartMotorController_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  iris_interfaces__srv__RestartMotorController_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(iris_interfaces__srv__RestartMotorController_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    iris_interfaces__srv__RestartMotorController_Response * data =
      (iris_interfaces__srv__RestartMotorController_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!iris_interfaces__srv__RestartMotorController_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          iris_interfaces__srv__RestartMotorController_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!iris_interfaces__srv__RestartMotorController_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
