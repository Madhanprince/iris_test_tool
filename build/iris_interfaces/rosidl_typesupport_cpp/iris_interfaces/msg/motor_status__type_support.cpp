...
static const _MotorStatus_type_support_symbol_names_t _MotorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iris_interfaces, msg, MotorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, iris_interfaces, msg, MotorStatus)),
  }
};
...
get_message_type_support_handle<iris_interfaces::msg::MotorStatus>()
{
  return &::iris_interfaces::msg::rosidl_typesupport_cpp::MotorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, iris_interfaces, msg, MotorStatus)() {
  return get_message_type_support_handle<iris_interfaces::msg::MotorStatus>();
}
