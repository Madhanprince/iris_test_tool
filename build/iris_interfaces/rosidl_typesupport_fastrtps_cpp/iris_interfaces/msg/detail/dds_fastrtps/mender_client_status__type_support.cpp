...
#include "iris_interfaces/msg/detail/mender_client_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const iris_interfaces::msg::MenderClientStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ota_client_state
  cdr << ros_message.ota_client_state;
  // Member: last_sync_with_server
  cdr << ros_message.last_sync_with_server;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  iris_interfaces::msg::MenderClientStatus & ros_message)
{
  // Member: ota_client_state
  cdr >> ros_message.ota_client_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iris_interfaces::msg::MenderClientStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const iris_interfaces::msg::MenderClientStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iris_interfaces::msg::MenderClientStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MenderClientStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const iris_interfaces::msg::MenderClientStatus *>(
...
static size_t _MenderClientStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MenderClientStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MenderClientStatus__callbacks = {
  "iris_interfaces::msg",
  "MenderClientStatus",
...
static rosidl_message_type_support_t _MenderClientStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MenderClientStatus__callbacks,
...
{
  return &iris_interfaces::msg::typesupport_fastrtps_cpp::_MenderClientStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iris_interfaces, msg, MenderClientStatus)() {
  return &iris_interfaces::msg::typesupport_fastrtps_cpp::_MenderClientStatus__handle;
}
