...
#include "iris_interfaces/msg/detail/a2_functional_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const iris_interfaces::msg::BrushStatus &,
...
{
bool cdr_serialize(
  const iris_interfaces::msg::VacuumStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const iris_interfaces::msg::A2FunctionalStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  iris_interfaces::msg::A2FunctionalStatus & ros_message)
{
  // Member: brush
  ...
  size_t current_alignment)
{
  ...
  // Member: brush
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        iris_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_BrushStatus(
  ...
  // Member: vacuum
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        iris_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_VacuumStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = iris_interfaces::msg::A2FunctionalStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const iris_interfaces::msg::A2FunctionalStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iris_interfaces::msg::A2FunctionalStatus *>(
    untyped_ros_message);
...
{
  return &iris_interfaces::msg::typesupport_fastrtps_cpp::_A2FunctionalStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iris_interfaces, msg, A2FunctionalStatus)() {
  return &iris_interfaces::msg::typesupport_fastrtps_cpp::_A2FunctionalStatus__handle;
}
