...
#include "iris_interfaces/msg/detail/motor_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const iris_interfaces::msg::MotorStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  iris_interfaces::msg::MotorStatus & ros_message)
{
  // Member: brake_state
  cdr >> ros_message.brake_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iris_interfaces::msg::MotorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const iris_interfaces::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iris_interfaces::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  return &iris_interfaces::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iris_interfaces, msg, MotorStatus)() {
  return &iris_interfaces::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
