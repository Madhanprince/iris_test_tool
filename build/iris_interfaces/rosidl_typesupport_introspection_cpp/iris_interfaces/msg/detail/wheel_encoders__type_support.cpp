...
{
  new (message_memory) iris_interfaces::msg::WheelEncoders(_init);
}

void WheelEncoders_fini_function(void * message_memory)
{
  auto typed_message = static_cast<iris_interfaces::msg::WheelEncoders *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WheelEncoders_message_member_array[2] = {
  {
    ...
    offsetof(iris_interfaces::msg::WheelEncoders, left_wheel_ticks),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(iris_interfaces::msg::WheelEncoders, right_wheel_ticks),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WheelEncoders_message_members = {
  ...
  2,  // number of fields
  sizeof(iris_interfaces::msg::WheelEncoders),
...
{
  return &::iris_interfaces::msg::rosidl_typesupport_introspection_cpp::WheelEncoders_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, iris_interfaces, msg, WheelEncoders)() {
  return &::iris_interfaces::msg::rosidl_typesupport_introspection_cpp::WheelEncoders_message_type_support_handle;
}
