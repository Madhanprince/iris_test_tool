...
#include "iris_interfaces/msg/detail/wheel_encoders__rosidl_typesupport_fastrtps_c.h"
...
using _WheelEncoders__ros_msg_type = iris_interfaces__msg__WheelEncoders;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: left_wheel_ticks
  {
    cdr << ros_message->left_wheel_ticks;
  }

  // Field name: right_wheel_ticks
  {
    cdr << ros_message->right_wheel_ticks;
  }
...
size_t get_serialized_size_iris_interfaces__msg__WheelEncoders(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name left_wheel_ticks
  {
    size_t item_size = sizeof(ros_message->left_wheel_ticks);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name right_wheel_ticks
  {
    size_t item_size = sizeof(ros_message->right_wheel_ticks);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _WheelEncoders__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_iris_interfaces__msg__WheelEncoders(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_iris_interfaces
size_t max_serialized_size_iris_interfaces__msg__WheelEncoders(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iris_interfaces__msg__WheelEncoders;
    is_plain =
      (
      offsetof(DataType, right_wheel_ticks) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _WheelEncoders__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_iris_interfaces__msg__WheelEncoders(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, iris_interfaces, msg, WheelEncoders)() {
