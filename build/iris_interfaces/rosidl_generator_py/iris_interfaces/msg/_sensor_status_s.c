...
bool iris_interfaces__msg__sensor_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("iris_interfaces.msg._sensor_status.SensorStatus", full_classname_dest, 47) == 0);
  }
  iris_interfaces__msg__SensorStatus * ros_message = _ros_message;
  {  // sensor_name
  ...
  {  // sensor_robot_position
    PyObject * field = PyObject_GetAttrString(_pymsg, "sensor_robot_position");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->sensor_robot_position, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // sensor_status
...
PyObject * iris_interfaces__msg__sensor_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("iris_interfaces.msg._sensor_status");
  ...
  {  // sensor_robot_position
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->sensor_robot_position.data,
      strlen(ros_message->sensor_robot_position.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "sensor_robot_position", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
