...
bool iris_interfaces__msg__navigation_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("iris_interfaces.msg._navigation_mode.NavigationMode", full_classname_dest, 51) == 0);
  }
  iris_interfaces__msg__NavigationMode * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of NavigationMode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("iris_interfaces.msg._navigation_mode");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavigationMode");
