...
class Metaclass_VacuumFaults(type):
    """Metaclass of message 'VacuumFaults'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__vacuum_faults
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__vacuum_faults
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__vacuum_faults
            cls._TYPE_SUPPORT = module.type_support_msg__msg__vacuum_faults
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__vacuum_faults
...
class VacuumFaults(metaclass=Metaclass_VacuumFaults):
    """Message class 'VacuumFaults'."""

    __slots__ = [
        '_squeeze_actuator_digital_fault',
    ...
    _fields_and_field_types = {
        'squeeze_actuator_digital_fault': 'uint8',
    ...
    def __init__(self, **kwargs):
        ...
        self.squeeze_actuator_digital_fault = kwargs.get('squeeze_actuator_digital_fault', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.squeeze_actuator_digital_fault != other.squeeze_actuator_digital_fault:
            return False
    ...
    @builtins.property
    def squeeze_actuator_digital_fault(self):
        """Message field 'squeeze_actuator_digital_fault'."""
        return self._squeeze_actuator_digital_fault

    @squeeze_actuator_digital_fault.setter
    def squeeze_actuator_digital_fault(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'squeeze_actuator_digital_fault' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'squeeze_actuator_digital_fault' field must be an unsigned integer in [0, 255]"
        self._squeeze_actuator_digital_fault = value
