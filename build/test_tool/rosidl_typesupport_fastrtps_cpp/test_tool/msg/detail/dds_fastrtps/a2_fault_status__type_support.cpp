...
#include "test_tool/msg/detail/a2_fault_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const test_tool::msg::BrushFaults &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  test_tool::msg::BrushFaults &);
...
{
bool cdr_serialize(
  const test_tool::msg::VacuumFaults &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  test_tool::msg::VacuumFaults &);
size_t get_serialized_size(
  const test_tool::msg::VacuumFaults &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const test_tool::msg::A2FaultStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_tool::msg::A2FaultStatus & ros_message)
{
  // Member: a2_fault_status
  cdr >> ros_message.a2_fault_status;
  ...
  size_t current_alignment)
{
  ...
  // Member: brush
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_tool::msg::typesupport_fastrtps_cpp::max_serialized_size_BrushFaults(
  ...
  // Member: vacuum
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        test_tool::msg::typesupport_fastrtps_cpp::max_serialized_size_VacuumFaults(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = test_tool::msg::A2FaultStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const test_tool::msg::A2FaultStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_tool::msg::A2FaultStatus *>(
    untyped_ros_message);
...
{
  return &test_tool::msg::typesupport_fastrtps_cpp::_A2FaultStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_tool, msg, A2FaultStatus)() {
  return &test_tool::msg::typesupport_fastrtps_cpp::_A2FaultStatus__handle;
}
