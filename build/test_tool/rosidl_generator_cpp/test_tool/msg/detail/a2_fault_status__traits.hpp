...
#ifndef TEST_TOOL__MSG__DETAIL__A2_FAULT_STATUS__TRAITS_HPP_
#define TEST_TOOL__MSG__DETAIL__A2_FAULT_STATUS__TRAITS_HPP_
...
// Member 'brush'
#include "test_tool/msg/detail/brush_faults__traits.hpp"
// Member 'vacuum'
#include "test_tool/msg/detail/vacuum_faults__traits.hpp"
...
inline void to_yaml(
  const test_tool::msg::A2FaultStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const test_tool::msg::A2FaultStatus & msg)
{
  return test_tool::msg::to_yaml(msg);
}

template<>
inline const char * data_type<test_tool::msg::A2FaultStatus>()
{
  return "test_tool::msg::A2FaultStatus";
}

template<>
inline const char * name<test_tool::msg::A2FaultStatus>()
{
  return "test_tool/msg/A2FaultStatus";
}

template<>
struct has_fixed_size<test_tool::msg::A2FaultStatus>
  : std::integral_constant<bool, has_fixed_size<test_tool::msg::BrushFaults>::value && has_fixed_size<test_tool::msg::VacuumFaults>::value> {};

template<>
struct has_bounded_size<test_tool::msg::A2FaultStatus>
  : std::integral_constant<bool, has_bounded_size<test_tool::msg::BrushFaults>::value && has_bounded_size<test_tool::msg::VacuumFaults>::value> {};

template<>
struct is_message<test_tool::msg::A2FaultStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TEST_TOOL__MSG__DETAIL__A2_FAULT_STATUS__TRAITS_HPP_
